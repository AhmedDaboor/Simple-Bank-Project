...
public:
     ...
     * @param Permission The permission to check from the clsUser::enPermissions enumeration
    ...
    bool CheckAccessPermission(enPermissions Permission) {
        ...
        // Check if the requested permission is part of the user's permissions
